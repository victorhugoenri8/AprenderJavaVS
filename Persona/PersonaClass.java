...
public class PersonaClass{
   ...
   private final static char SEXO_DEF = 'H';
     ...
     * @param string
     */
    public PersonaClass(String string, int i, char c, double d) {
        this("", 0, SEXO_DEF, 0, 0);
    }
     ...
     */
    public PersonaClass(String nombre, int edad, char sexo) {
     ...
     */
    public PersonaClass(String nombre, int edad, char sexo, double peso, double altura) {
        this.nombre = nombre;
        this.edad = edad;
        this.peso = peso;
        this.altura = altura;
